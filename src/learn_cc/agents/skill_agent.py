...
class SkillAgent(BaseAgent):
    ...
    skills_path = workspace_root / "skills"
    subAgentConfigMap = {
    ...
    def __init__(
        ...
        self.skill_loader = SkillsLoader(self.skills_path)
        print(f"Skills loaded: {self.skill_loader.skill_meta_desp()}")
        self.subAgents = {
            name: BaseAgent(
                model=model,
        ...
        super().__init__(
            ...
            tools=[
                StructuredTool.from_function(
                    func=self.skill_loader.get_skill_content,
                    name="run_agent_skill",
                    description=f"""
                        Choose a Skill to get details.

                        Args:
                        name: the name of skill

                        {self.skill_loader.skill_meta_desp()}
                    """,
                ),
                StructuredTool.from_function(
